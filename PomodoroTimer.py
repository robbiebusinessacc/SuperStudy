...
class PomodoroTimer(object):
    def __init__(self):
        ...
        self.reset_menu_item = NSMenuItem.alloc().initWithTitle_action_keyEquivalent_(
            "Reset", "resetTimer:", ""
        )
        ...
        self.duration_menu_item = (
            NSMenuItem.alloc().initWithTitle_action_keyEquivalent_("Duration", None, "")
        )
        ...
        for duration in [
            ...
            menu_item = NSMenuItem.alloc().initWithTitle_action_keyEquivalent_(
                "{} minutes".format(duration // 60), "setDuration:", ""
            )
        ...
        for break_duration in [
            ...
            menu_item = NSMenuItem.alloc().initWithTitle_action_keyEquivalent_(
                "{} minutes".format(break_duration // 60), "setBreakDuration:", ""
            )
    ...
    def startBreak_(self, sender):
        ...
        self.break_timer = (
            NSTimer.scheduledTimerWithTimeInterval_target_selector_userInfo_repeats_(
                1.0, self, "update_break_time", None, True
            )
        )
    ...
    def update_status_item(self):
        ...
        if self.remaining_time > 0:
            ...
            self.statusitem.setTitle_(
                "Studying: {:02d}:{:02d}".format(minutes, seconds)
            )
        else:
