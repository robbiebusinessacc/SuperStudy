...
class MacOSMenuBar(object):
    def __init__(self):
        ...
        self.music_player_menu_item = (
            NSMenuItem.alloc().initWithTitle_action_keyEquivalent_(
                "Music Player", "startMusicPlayer:", ""
            )
        )
        self.music_player_menu_item.setTarget_(self)
        self.menu.addItem_(self.music_player_menu_item)
        self.dark_light_mode_switch_menu_item = (
            NSMenuItem.alloc().initWithTitle_action_keyEquivalent_(
                "Dark/Light Mode Switch", "startDarkLightModeSwitch:", ""
            )
        )
